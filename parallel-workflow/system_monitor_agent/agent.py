...
# --- 2. Create Sequential Pipeline ----
# chain together 3 parallel agents, which responses are saved in state, wrapped in a
# system_info_gatherer and synthesizer agent to gather info in parallel, then synthesize
