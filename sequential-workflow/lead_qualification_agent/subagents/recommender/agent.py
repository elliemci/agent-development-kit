...
action_recommender_agent = LlmAgent(
    ...
    output_key="action_recommendation",  # based on the lead_score and validation_status state kesy, the recommender sugest and actions and saves the recommendation in state "action_recommendation" key
)
